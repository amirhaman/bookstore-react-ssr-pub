...
export default function ShoppingCartEntry() {
  ...
  return (
    <Box className="relative">
      ...
      <Typography fontWeight="bolder" className="mr-8" component="h4" color="primary" sx={{ color: "primary.light", left: "-20px", top: "0", textAlign: "center", minHeight: "10px", minWidth: "24px", bgcolor: "primary.dark", borderRadius: "50%" }}>
        {shoppingCart.items.length}
      </Typography>
      <ShoppingCartIcon className="cursor-pointer" color="primary" sx={{ position: "absolute", right: "0", top: "-6px", color: "primary.light" }} style={{ fontSize: "35px" }} onClick={() => handleShoppingCartModal()}></ShoppingCartIcon>
    </Box>
  );
}
