      ...
      <Grid container className="w-full">
        <Grid item className="w-full">
          <BookTextField
            ...
            name="name"
            value={name}
            updatedValue={updatedFields.name}
            label="Name"
            handleFieldChangeReducer={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChangeReducer(e, 'name')}
          />
        </Grid>
        <Grid item className="w-full">
          <BookTextField
            ...
            updatedValue={updatedFields.price}
            label="Price"
            handleFieldChangeReducer={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChangeReducer(e, 'price')}
          />
        </Grid>
        <Grid item className="w-full">
          <BookTextField
